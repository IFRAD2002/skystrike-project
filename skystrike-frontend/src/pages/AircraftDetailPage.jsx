      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="lg:w-1/3">
          <div className="card bg-base-100 shadow-xl sticky top-24">
            ...
            <div className="card-body">
              <div className="flex justify-between items-center"><h2 className="card-title text-3xl">{aircraft.model}</h2>{userRole && <button className="btn btn-outline btn-xs" onClick={() => setOpenModal('edit')}>Edit</button>}</div>
        ...
        <div className="lg:w-2/3">
          ...
          <div className="card bg-base-100 shadow-xl">
            {activeTab === 'history' && (
              <div className="card-body">
                <div className="flex justify-between items-center"><h2 className="card-title">Maintenance History</h2>{userRole && (<button className="btn btn-primary btn-sm" onClick={() => setOpenModal('log')}>Log Maintenance</button>)}</div>
            ...
            {activeTab === 'schedule' && (
              <div className="card-body">
                <div className="flex justify-between items-center"><h2 className="card-title">Scheduled Maintenance</h2>{userRole && <button className="btn btn-secondary btn-sm" onClick={() => setOpenModal('schedule')}>Schedule</button>}</div>
